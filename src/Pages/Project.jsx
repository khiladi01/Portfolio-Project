...
function Project () {
    return(
        <>
        <div className="min-h-screen bg-transparent flex flex-col items-center gap-[50px] select-none px-2">
  {/* heading */}
  ...
  <div className="w-full max-w-[1200px] flex flex-wrap justify-center items-center gap-[20px]">
    {[{
      ...
      <div key={id} id={id} className="w-full sm:w-[80%] md:w-[48%] lg:w-[31%] h-[500px] rounded-xl grid place-content-center">
