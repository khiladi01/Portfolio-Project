...
function Footer () {
    return(
        ...
        <footer className="select-none">
            <div className="min-h-[180px] bg-[#0F0E1C] flex flex-col md:flex-row justify-between p-5 gap-8 md:gap-0">
            {/* Adding name */}
            ...
            <div className="w-full md:w-auto text-center md:text-left">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-10 text-[#eae2b7] mt-2 justify-center md:justify-start">
                    <ul className="float-left">
                        <li><Link className="hover:text-[#00FFF0] decoration-[#eae2b7] transition-all ease-in-out duration-200 font-medium tracking-wider" to=''>Projects</Link></li>
                        <li><Link className="hover:text-[#00FFF0] decoration-[#eae2b7] transition-all ease-in-out duration-200 font-medium tracking-wider" to=''>Skills</Link></li>
                        <li><Link className="hover:text-[#00FFF0] decoration-[#eae2b7] transition-all ease-in-out duration-200 font-medium tracking-wider" to=''>Resume</Link></li>
                        <li><Link className="hover:text-[#00FFF0] decoration-[#eae2b7] transition-all ease-in-out duration-200 font-medium tracking-wider" to=''>Chat</Link></li>
                    </ul>
                </div>
            </div>
