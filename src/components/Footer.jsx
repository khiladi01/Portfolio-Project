    ...
    return(
        ...
        <footer className="select-none">
            ...
            <div className="w-full md:w-auto text-center md:text-left">
                ...
                <p className="text-[17px] bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent font-normal -tracking-wider">Frontend + 3D Web Developer | Building Web Magic</p>
            </div>
            {/* Adding links */}
            <div className="w-full md:w-auto text-center md:text-left">
                <h2 className="uppercase text-[20px] text-[#00FFF0] font-semibold -tracking-tighter">important links</h2>
                <div className="flex flex-col md:flex-row gap-4 md:gap-10 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent mt-2 justify-center md:justify-start">
            ...
            <div className="w-full md:w-auto text-center md:text-left">
                ...
                <div className="flex gap-4 mt-2 justify-center md:justify-start">
                    <Link to='https://www.linkedin.com/in/raushan-raj-98609b269'>
                        <i className='bx bxl-linkedin text-2xl bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent hover:transform-content hover:scale-110 transition-all ease-in-out duration-200'></i>
                    </Link>
                    <Link to='https://github.com/khiladi01/Portfolio-Project'>
                        <i className='bx bxl-github text-2xl bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent hover:transform-content hover:scale-110 transition-all ease-in-out duration-200'></i>
                    </Link>
                    <Link to='https://www.instagram.com/iamakshayraj01?igsh=YnNodHZpa2ZncjQx'>
                        <i className='bx bxl-instagram text-2xl bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent hover:transform-content hover:scale-110 transition-all ease-in-out duration-200'></i>
                    </Link>
                </div>
            </div>
            ...
            <div className="h-[50px] bg-transparent flex justify-center items-center">
